      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative">
        ...
        >
          <div className="w-16 h-16 bg-[#5865F2]/10 border border-[#5865F2]/20 rounded-2xl flex items-center justify-center mx-auto mb-6 text-[#5865F2]">
            <img className='w-8 h-8 flex items-center justify-center shadow-md' src='/discord.svg'/>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <img className='w-4 h-4 flex items-center justify-center shadow-md' src='/github.svg'/>
